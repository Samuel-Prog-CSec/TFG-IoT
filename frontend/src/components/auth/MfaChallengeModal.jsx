      ...
      <div className="bg-background-elevated border border-border-default rounded-2xl shadow-xl max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="w-full px-4 py-3 rounded-lg border border-border-default bg-background-base text-text-primary text-center text-2xl tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-brand-base"
          ...
          <div className="flex items-center justify-between mt-4 gap-3">
            ...
            <div className="flex gap-2">
              <button
                type="button"
                onClick={() => close(true)}
                className="px-4 py-2 rounded-lg border border-border-default text-text-primary hover:bg-background-base"
                disabled={submitting}
              >
                Cancelar
              </button>
              <button
                ...
                className="px-4 py-2 rounded-lg bg-brand-base text-white hover:bg-brand-strong disabled:opacity-50 disabled:cursor-not-allowed"
              >
